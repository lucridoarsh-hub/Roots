// app/invite/[role]/[userId]/page.tsx (or pages/invite/[role]/[userId].tsx)
"use client";
...
// ========== COMPONENT ==========
const InviteRegisterUserPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        `/api/auth/invitation-register/${role}/${userId}`,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  You've been invited to become part of a family circle.
                </p>
                <div
                  style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {isLoading ? "Creating Account..." : "Accept Invitation & Register"}{" "}
                <ArrowRight size={18} />
              </button>
            </form>
...
export default InviteRegisterUserPage;