...
const FamilyPage: React.FC = () => {
  ...
  const openEditModal = () => {
    ...
    setEditMemoryData({
      ...
      date: selectedMemory.date.split("T")[0], // format for input
    });
    setRemovedImages([]);
    setNewImages([]);
  ...
  const headerMuted = isDark ? theme.colors.brand[200] : theme.colors.brand[200];
  ...
  const cardHeaderBg = isDark ? theme.colors.brand[900] + "80" : "rgba(249,250,251,0.5)";
  const divideColor = isDark ? "rgba(255,255,255,0.05)" : theme.colors.gray[100];
  const memberHoverBg = isDark ? "rgba(255,255,255,0.05)" : theme.colors.gray[50];
  ...
  const pendingBg = isDark ? theme.colors.amber[900] + "66" : theme.colors.amber[100];
  const pendingText = isDark ? theme.colors.amber[400] : theme.colors.amber[700];
  const selectBg = isDark ? theme.colors.brand[800] : theme.colors.gray[100];
  const selectText = isDark ? theme.colors.brand[200] : theme.colors.gray[700];
  const removeBtnColor = isDark ? theme.colors.brand[700] : theme.colors.gray[300];
const removeBtnHoverBg = isDark
  ? theme.colors.red[500] + "33"
  : theme.colors.red[50];
  const removeBtnHoverText = isDark ? theme.colors.red[400] : theme.colors.red[500];
  ...
  const guideCardBg = isDark ? theme.colors.brand[900] : theme.colors.white;
  const guideCardBorder = isDark ? "rgba(255,255,255,0.05)" : theme.colors.gray[100];
  const viewerDot = theme.colors.gray[400];
  const commenterDot = theme.colors.blue[500];
  const contributorDot = theme.colors.purple[500];
  const modalBg = isDark ? theme.colors.brand[950] : theme.colors.white;
  const modalBorder = isDark ? "rgba(255,255,255,0.1)" : "rgba(255,255,255,0.1)";
  const modalHeaderBg = isDark ? theme.colors.brand[900] + "80" : "rgba(249,250,251,0.5)";
  const modalHeaderBorder = isDark ? "rgba(255,255,255,0.05)" : theme.colors.gray[100];
  ...
  const radioOptionBg = isDark ? theme.colors.brand[900] + "66" : theme.colors.brand[50];
  const radioOptionBorder = isDark ? "rgba(255,255,255,0.1)" : theme.colors.gray[200];
  const radioOptionActiveBg = isDark ? theme.colors.brand[900] + "66" : theme.colors.brand[50];
  const radioOptionActiveBorder = theme.colors.brand[600];
  const radioOptionActiveRing = theme.colors.brand[500] + "33";
  const radioOptionText = isDark ? theme.colors.white : theme.colors.gray[900];
  const radioOptionDesc = isDark ? theme.colors.brand[400] : theme.colors.gray[500];
  const submitBtnBg = isDark ? theme.colors.brand[600] : theme.colors.brand[900];
  const submitBtnHoverBg = isDark ? theme.colors.brand[500] : theme.colors.brand[800];
  const commentBg = isDark ? theme.colors.brand[800] + "80" : theme.colors.gray[100];
  const commentText = isDark ? theme.colors.gray[300] : theme.colors.gray[600];
  const commentBorder = isDark ? "rgba(255,255,255,0.1)" : theme.colors.gray[200];
        ...
        >
          ...
          >
            ...
            >
              <div
                style={{
                  color: isDark ? theme.colors.brand[300] : theme.colors.gray[900],
                  fontWeight: 900,
                  fontSize: theme.fontSize.xs,
                  textTransform: "uppercase",
                  letterSpacing: "0.1em",
