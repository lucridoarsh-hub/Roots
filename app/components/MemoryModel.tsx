        ...
        >
          {isSaved ? (
            ...
            >
              ...
              <p style={{ color: textMuted, fontSize: theme.fontSize.lg, maxWidth: '280px', marginBottom: theme.spacing(8) }}>
              ...
              <div style={{ flex: 1, overflowY: 'auto' }}>
                ...
                >
                  ...
                  {fileValidationError && (
                    ...
                    >
                      ...
                      <button
                        ...
                        style={{ background: 'none', border: 'none', cursor: 'pointer', color: errorText }}
                      >
                        <X size={14} />
                      </button>
                    </div>
                  ...
                  <div>
                    ...
                    >
                      Tags <span style={{ fontWeight: 400, color: textMuted }}>(comma separated)</span>
                    </label>
                    <input
                      type="text"
                      value={tags}
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: theme.spacing(4) }}>
                      ...
                      {selectedFiles.length > 0 && (
                        <span style={{ color: textMuted, fontSize: theme.fontSize.sm, fontWeight: 500 }}>
                  ...
                  >
                    <button
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.color = cancelBtnHoverColor)}
                      onMouseLeave={(e) => (e.currentTarget.style.color = cancelBtnColor)}
                    >
                      Cancel
                    </button>
